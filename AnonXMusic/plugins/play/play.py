    ...
    [
        [
            InlineKeyboardButton(   
              text=f"اضغط للأشتراك .", url=f"t.me/YlQIl",)                        
        ],        
    ]
)
async def check_is_joined(message):    
    try:
        ...
        status = await app.get_chat_member("YlQIl", userid)
        return True
    except Exception:
        await message.reply_text(f'❤️‍🩹┇عزيزي: {message.from_user.mention}\n🫀┇أشتࢪك في قناة البوت أولاً.\n🚧┇قناة البوت: @YlQIl 🫂',reply_markup=force_btn,disable_web_page_preview=False)
        return False
